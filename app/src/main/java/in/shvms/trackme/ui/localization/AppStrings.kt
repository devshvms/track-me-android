...
open class AppStrings(private val overrides: Map<String, String> = emptyMap()) {
    ...
    val compareRidesTitle: String = s("compareRidesTitle", "Compare rides")
    val compareRidesShare: String = s("compareRidesShare", "Share comparison")
    val compareRidesMapNotReady: String = s("compareRidesMapNotReady", "Map is not ready yet")
    val compareRidesNoSelection: String = s("compareRidesNoSelection", "Select at least two rides to compare.")
...
fun getAppStrings(languageCode: String): AppStrings {
    return when (languageCode) {
        "es" -> AppStrings(mapOf(
            ...
            "compareRidesTitle" to "Comparar viajes",
            "compareRidesShare" to "Compartir comparación",
            "compareRidesMapNotReady" to "El mapa aún no está listo",
            "compareRidesNoSelection" to "Selecciona al menos dos viajes para comparar.",
        ...
        "fr" -> AppStrings(mapOf(
            ...
            "compareRidesTitle" to "Comparer les trajets",
            "compareRidesShare" to "Partager la comparaison",
            "compareRidesMapNotReady" to "La carte n’est pas encore prête",
            "compareRidesNoSelection" to "Sélectionnez au moins deux trajets à comparer.",
        ...
        "de" -> AppStrings(mapOf(
            ...
            "compareRidesTitle" to "Fahrten vergleichen",
            "compareRidesShare" to "Vergleich teilen",
            "compareRidesMapNotReady" to "Karte ist noch nicht bereit",
            "compareRidesNoSelection" to "Wähle mindestens zwei Fahrten zum Vergleichen aus.",
        ...
        "hi" -> AppStrings(mapOf(
            ...
            "compareRidesTitle" to "यात्राओं की तुलना करें",
            "compareRidesShare" to "तुलना साझा करें",
            "compareRidesMapNotReady" to "मानचित्र अभी तैयार नहीं है",
            "compareRidesNoSelection" to "तुलना के लिए कम से कम दो यात्राएं चुनें।",
        ...
        "ja" -> AppStrings(mapOf(
            ...
            "compareRidesTitle" to "ライドを比較",
            "compareRidesShare" to "比較を共有",
            "compareRidesMapNotReady" to "地図の準備がまだできていません",
            "compareRidesNoSelection" to "比較するライドを2つ以上選択してください。",
        ...
        "zh" -> AppStrings(mapOf(
            ...
            "compareRidesTitle" to "比较骑行",
            "compareRidesShare" to "分享比较结果",
            "compareRidesMapNotReady" to "地图尚未准备好",
            "compareRidesNoSelection" to "请选择至少两次骑行进行比较。",
