...
open class AppStrings(internal val overrides: Map<String, String> = emptyMap()) {
    ...
    // SCOPE_1.8.9 — export templates (TASK-324)
    val exportTabTemplates: String = s("exportTabTemplates", "Templates")
    val exportTabCustom: String = s("exportTabCustom", "Custom")
    val templateTrace: String = s("templateTrace", "Trace")
    val templateInstrument: String = s("templateInstrument", "Instrument")
    ...
    val templateFastestKm: String = s("templateFastestKm", "Fastest km")
    val templateFastestMi: String = s("templateFastestMi", "Fastest mile")
    val templateUnitKilometres: String = s("templateUnitKilometres", "Kilometres")
    val templateUnitMiles: String = s("templateUnitMiles", "Miles")
    val templatePlaceOff: String = s("templatePlaceOff", "No place")
    val templatePlaceBoth: String = s("templatePlaceBoth", "Start & finish")
    val templatePlaceFinish: String = s("templatePlaceFinish", "Finish only")
    val templatePlaceNote: String = s("templatePlaceNote", "Place names are looked up once by your phone's map service, then kept on this device.")
    val templateMapBackground: String = s("templateMapBackground", "Map background")
    val templateLightAuto: String = s("templateLightAuto", "Auto")
    val lightDawn: String = s("lightDawn", "First light")
    val lightGolden: String = s("lightGolden", "Golden hour")
    val lightDay: String = s("lightDay", "Daylight")
    val lightDusk: String = s("lightDusk", "Last light")
    val lightNight: String = s("lightNight", "After dark")
    val awardBadgePr: String = s("awardBadgePr", "PR")
    val awardBadgeFirst: String = s("awardBadgeFirst", "1st")
    val awardCaptionRides: String = s("awardCaptionRides", "Rides")
    val awardCaptionRide: String = s("awardCaptionRide", "Ride")
    val awardHeadlineDistance: String = s("awardHeadlineDistance", "Longest yet")
    val awardHeadlineDuration: String = s("awardHeadlineDuration", "Longest time out")
    val awardHeadlineFirst: String = s("awardHeadlineFirst", "First ride")
    val awardHeadlineMilestone: String = s("awardHeadlineMilestone", "%1\$d rides")
    val awardPreviousBest: String = s("awardPreviousBest", "Previous best %1\$s")
...
fun getAppStrings(languageCode: String): AppStrings {
    return when (languageCode) {
        "es" -> AppStrings(mapOf(
            ...
            "exportTabTemplates" to "Plantillas",
            "exportTabCustom" to "Personalizar",
            "templateTrace" to "Trazado",
            "templateInstrument" to "Instrumento",
            ...
            "templateFastestKm" to "Km más rápido",
            "templateFastestMi" to "Milla más rápida",
            "templateUnitKilometres" to "Kilómetros",
            "templateUnitMiles" to "Millas",
            "templatePlaceOff" to "Sin lugar",
            "templatePlaceBoth" to "Inicio y fin",
            "templatePlaceFinish" to "Solo el final",
            "templatePlaceNote" to "Los nombres se consultan una vez al servicio de mapas del teléfono y se guardan en este dispositivo.",
            "templateMapBackground" to "Mapa de fondo",
            "templateLightAuto" to "Automático",
            "lightDawn" to "Primera luz",
            "lightGolden" to "Hora dorada",
            "lightDay" to "Pleno día",
            "lightDusk" to "Última luz",
            "lightNight" to "De noche",
            "awardBadgePr" to "RP",
            "awardBadgeFirst" to "1.º",
            "awardCaptionRides" to "Viajes",
            "awardCaptionRide" to "Viaje",
            "awardHeadlineDistance" to "El más largo hasta ahora",
            "awardHeadlineDuration" to "El más largo en tiempo",
            "awardHeadlineFirst" to "Primer viaje",
            "awardHeadlineMilestone" to "%1\$d viajes",
            "awardPreviousBest" to "Mejor anterior: %1\$s",
            "retry" to "Reintentar",
        ...
        "fr" -> AppStrings(mapOf(
            ...
            "exportTabTemplates" to "Modèles",
            "exportTabCustom" to "Personnaliser",
            "templateTrace" to "Tracé",
            "templateInstrument" to "Relevé",
            ...
            "templateFastestKm" to "Km le plus rapide",
            "templateFastestMi" to "Mile le plus rapide",
            "templateUnitKilometres" to "Kilomètres",
            "templateUnitMiles" to "Milles",
            "templatePlaceOff" to "Sans lieu",
            "templatePlaceBoth" to "Départ et arrivée",
            "templatePlaceFinish" to "Arrivée seule",
            "templatePlaceNote" to "Les noms sont recherchés une fois via le service de cartes du téléphone, puis conservés sur cet appareil.",
            "templateMapBackground" to "Carte en fond",
            "templateLightAuto" to "Automatique",
            "lightDawn" to "Premières lueurs",
            "lightGolden" to "Heure dorée",
            "lightDay" to "Plein jour",
            "lightDusk" to "Dernières lueurs",
            "lightNight" to "À la nuit",
            "awardBadgePr" to "RP",
            "awardBadgeFirst" to "1er",
            "awardCaptionRides" to "Trajets",
            "awardCaptionRide" to "Trajet",
            "awardHeadlineDistance" to "Le plus long à ce jour",
            "awardHeadlineDuration" to "La plus longue sortie",
            "awardHeadlineFirst" to "Premier trajet",
            "awardHeadlineMilestone" to "%1\$d trajets",
            "awardPreviousBest" to "Meilleur précédent : %1\$s",
            "retry" to "Réessayer",
        ...
        "de" -> AppStrings(mapOf(
            ...
            "exportTabTemplates" to "Vorlagen",
            "exportTabCustom" to "Anpassen",
            "templateTrace" to "Spur",
            "templateInstrument" to "Messwerte",
            ...
            "templateFastestKm" to "Schnellster km",
            "templateFastestMi" to "Schnellste Meile",
            "templateUnitKilometres" to "Kilometer",
            "templateUnitMiles" to "Meilen",
            "templatePlaceOff" to "Kein Ort",
            "templatePlaceBoth" to "Start & Ziel",
            "templatePlaceFinish" to "Nur Ziel",
            "templatePlaceNote" to "Ortsnamen werden einmal über den Kartendienst des Telefons abgefragt und dann auf diesem Gerät gespeichert.",
            "templateMapBackground" to "Karte im Hintergrund",
            "templateLightAuto" to "Automatisch",
            "lightDawn" to "Erstes Licht",
            "lightGolden" to "Goldene Stunde",
            "lightDay" to "Tageslicht",
            "lightDusk" to "Letztes Licht",
            "lightNight" to "Bei Nacht",
            "awardBadgePr" to "PB",
            "awardBadgeFirst" to "1.",
            "awardCaptionRides" to "Fahrten",
            "awardCaptionRide" to "Fahrt",
            "awardHeadlineDistance" to "Längste bisher",
            "awardHeadlineDuration" to "Längste Zeit unterwegs",
            "awardHeadlineFirst" to "Erste Fahrt",
            "awardHeadlineMilestone" to "%1\$d Fahrten",
            "awardPreviousBest" to "Bisherige Bestmarke %1\$s",
        ...
        "hi" -> AppStrings(mapOf(
            ...
            "exportTabTemplates" to "टेम्पलेट",
            "exportTabCustom" to "कस्टम",
            "templateTrace" to "रूट",
            "templateInstrument" to "आँकड़े",
            ...
            "itineraryRides" to "%1\$d राइड्स",
            "templateElevation" to "ऊँचाई",
            "templateElevationLine" to "ऊँचाई · %1\$s चढ़ाई",
            "templateSplitsLine" to "स्प्लिट · %1\$s",
            "templateFastestKm" to "सबसे तेज़ किमी",
            "templateFastestMi" to "सबसे तेज़ मील",
            "templateUnitKilometres" to "किलोमीटर",
            "templateUnitMiles" to "मील",
            "templatePlaceOff" to "जगह नहीं",
            "templatePlaceBoth" to "शुरू और अंत",
            "templatePlaceFinish" to "केवल अंत",
            "templatePlaceNote" to "जगहों के नाम एक बार फ़ोन की मैप सेवा से लिए जाते हैं, फिर इसी डिवाइस पर रखे जाते हैं।",
            "templateMapBackground" to "पृष्ठभूमि में मैप",
            "templateLightAuto" to "ऑटो",
            "lightDawn" to "पहली रोशनी",
            "lightGolden" to "सुनहरा पहर",
            "lightDay" to "दिन का उजाला",
            "lightDusk" to "आख़िरी रोशनी",
            "lightNight" to "अँधेरे में",
            "awardBadgePr" to "रिकॉर्ड",
            "awardBadgeFirst" to "पहली",
            "awardCaptionRides" to "राइड्स",
            "awardCaptionRide" to "राइड",
            "awardHeadlineDistance" to "अब तक की सबसे लंबी",
            "awardHeadlineDuration" to "सबसे लंबा समय",
            "awardHeadlineFirst" to "पहली राइड",
            "awardHeadlineMilestone" to "%1\$d राइड्स",
            "awardPreviousBest" to "पिछला सर्वश्रेष्ठ %1\$s",
        ...
        "ja" -> AppStrings(mapOf(
            ...
            "exportTabTemplates" to "テンプレート",
            "exportTabCustom" to "カスタム",
            "templateTrace" to "ルート",
            "templateInstrument" to "データ",
            "templateSticker" to "ステッカー",
            "templateHour" to "光",
            "templateAward" to "達成",
            "templateItinerary" to "行程",
            "itineraryRegions" to "%1\$d地域",
            "itineraryRides" to "%1\$d 回のライド",
            "templateElevation" to "標高",
            "templateElevationLine" to "標高 · 獲得 %1\$s",
            "templateSplitsLine" to "スプリット · %1\$s",
            "templateFastestKm" to "最速の 1 km",
            "templateFastestMi" to "最速の 1 マイル",
            "templateUnitKilometres" to "キロメートル",
            "templateUnitMiles" to "マイル",
            "templatePlaceOff" to "地名なし",
            "templatePlaceBoth" to "出発地と到着地",
            "templatePlaceFinish" to "到着地のみ",
            "templatePlaceNote" to "地名はスマートフォンの地図サービスで一度だけ調べ、この端末に保存されます。",
            "templateMapBackground" to "背景に地図",
            "templateLightAuto" to "自動",
            "lightDawn" to "夜明け",
            "lightGolden" to "ゴールデンアワー",
            "lightDay" to "日中",
            "lightDusk" to "夕暮れ",
            "lightNight" to "夜",
            "awardBadgePr" to "自己新",
            "awardBadgeFirst" to "初",
            "awardCaptionRides" to "ライド",
            "awardCaptionRide" to "ライド",
            "awardHeadlineDistance" to "過去最長",
            "awardHeadlineDuration" to "過去最長の時間",
            "awardHeadlineFirst" to "初めてのライド",
            "awardHeadlineMilestone" to "%1\$d 回のライド",
            "awardPreviousBest" to "これまでのベスト %1\$s",
            "retry" to "再試行",
        ...
        "zh" -> AppStrings(mapOf(
            ...
            "exportTabTemplates" to "模板",
            "exportTabCustom" to "自定义",
            "templateTrace" to "轨迹",
            "templateInstrument" to "仪表",
            ...
            "templateFastestKm" to "最快 1 公里",
            "templateFastestMi" to "最快 1 英里",
            "templateUnitKilometres" to "公里",
            "templateUnitMiles" to "英里",
            "templatePlaceOff" to "不显示地点",
            "templatePlaceBoth" to "起点和终点",
            "templatePlaceFinish" to "仅终点",
            "templatePlaceNote" to "地点名称会通过手机的地图服务查询一次，然后仅保存在本设备上。",
            "templateMapBackground" to "地图背景",
            "templateLightAuto" to "自动",
            "lightDawn" to "破晓",
            "lightGolden" to "黄金时刻",
            "lightDay" to "白昼",
            "lightDusk" to "暮光",
            "lightNight" to "夜色",
            "awardBadgePr" to "新纪录",
            "awardBadgeFirst" to "首次",
            "awardCaptionRides" to "次骑行",
            "awardCaptionRide" to "骑行",
            "awardHeadlineDistance" to "迄今最远",
            "awardHeadlineDuration" to "迄今最久",
            "awardHeadlineFirst" to "首次骑行",
            "awardHeadlineMilestone" to "%1\$d 次骑行",
            "awardPreviousBest" to "此前最佳 %1\$s",
            "retry" to "重试",
